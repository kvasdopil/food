...
export function RecipeFeedCard({
  ...
  return (
    <Link href={`/recipes/${slug}`} className="block">
      <Card className="relative h-full w-full cursor-pointer overflow-hidden rounded-none border-0 transition-opacity hover:opacity-95 sm:rounded-lg sm:shadow-md lg:shadow-lg">
