...
- `src/app/feed/page.tsx`: server component that generates a random seed for SSR and passes it to the client component. Ensures the same seed is used for both server render and client hydration.
